...
public partial class GridManager : Node
{
    ...
    public bool IsTileAreaBuildable(Rect2I tileArea, bool isAtttackTiles = false)
    {
        ...
        var tileSetToCheck = GetBuildableTileSet(isAtttackTiles);
        if (isAtttackTiles)
        {
    ...
    )
    {
        ...
        foreach (var dependantBuilding in dependentBuildings)
        {
    ...
    private void CheckDangerBuildingDestruction()
    {
        ...
        foreach (var building in dangerBuildings)
        {
            ...
            var isInsideAttackTile = tileArea
                .ToTiles()
